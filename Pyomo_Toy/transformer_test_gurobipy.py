...
class TestTransformer(unittest.TestCase):    
    ...
    def test_layer_norm(self):
        ...
        # transformer output
        LN_1_output= np.array(tir.layer_outputs_dict["layer_normalization_1"]).flatten()
    ...
    def test_multi_head_attention(self):
        ...
        self.assertIsNone(np.testing.assert_array_almost_equal(np.array(tir.layer_outputs_dict["layer_normalization_1"]).flatten(),LN_output, decimal =5))
        ...
        ## Check MHA output
        MHA_output = np.array(tir.layer_outputs_dict["multi_head_attention_1"]).flatten()
    ...
    def test_add_residual(self):
        ...
        input = np.array(tir.layer_outputs_dict["input_layer_1"]).flatten()
    ...
    def test_layer_norm_2(self):
        ...
        LN_2_output= np.array(tir.layer_outputs_dict["layer_normalization_2"]).flatten()
    ...
    def test_FFN1(self):
        ...
        FFN_out= np.array(tir.layer_outputs_dict["dense_2"]).flatten()
    ...
    def test_avg_pool(self):
        ...
        avg_pool_out = np.array(tir.layer_outputs_dict["global_average_pooling1d_1"]).flatten()
    ...
    def test_FFN2(self):
        ...
        FFN_out = np.array(tir.layer_outputs_dict["dense_4"]).flatten()
